...
def loop_through_all_the_folders(folder_with_runs_path_):
    ...
    for folder in Path(folder_with_runs_path_).glob("*"):
        ...
        try:
            ...
            event_data = collect_event_summary(event_result)
