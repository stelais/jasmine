...
def main(file_path_, run_version_):
    ...
    df['best_mass_ratio'] = df.apply(lambda row: row[f"{str(row['best_chi2_name']).replace('_chi2', '')}_mass_ratio"], axis=1)
    ...
    # print('This is the one we will use to select events.: master_combined_or', master_combined_or)
    # --- Step 5: select rows ---
    # selected = df[master_combined_or].copy()
    ...
    if run_version_ == 'v31':
        root_path = f'/Users/stela/Documents/Scripts/orbital_task/RTModel_runs/sample_rtmodel_v3.1'
    elif run_version_ == 'v24':
        root_path = f'/Users/stela/Documents/Scripts/orbital_task/RTModel_runs/sample_rtmodel_v2.4'
    elif run_version_ == 'ICGS':
        root_path = f'/Users/stela/Documents/Scripts/orbital_task/RTModel_runs/154_failures_v24_v31'
    else:
        raise ValueError("Invalid run_version. Use 'v31' or 'v24'.")
    selected_c1.to_csv(f'{root_path}/c1_{run_version_}_events_failure_in_q.csv', index=False)
    selected_c2.to_csv(f'{root_path}/c2_{run_version_}_events_failure_in_q.csv', index=False)
    selected_c3.to_csv(f'{root_path}/c3_{run_version_}_events_failure_in_q.csv', index=False)
...
if __name__  == "__main__":
    ...
    print(run_version)
    if run_version == 'v31':
        file_path = '/Users/stela/Documents/Scripts/orbital_task/RTModel_runs/sample_rtmodel_v3.1/v3.1_true_and_rtmodel_fits.csv'
    elif run_version == 'v24':
        file_path = '/Users/stela/Documents/Scripts/orbital_task/RTModel_runs/sample_rtmodel_v2.4/true_and_rtmodel_fits.csv'
    elif run_version == 'ICGS':
        file_path = '/Users/stela/Documents/Scripts/orbital_task/RTModel_runs/154_failures_v24_v31/ICGS_true_and_rtmodel_fits_done.csv'
    else:
        raise ValueError("Invalid run_version. Use 'v31' or 'v24' or 'ICGS'.")
    main(file_path, run_version)