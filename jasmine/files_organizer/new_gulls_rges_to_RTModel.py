...
def creating_all_directories(*,
    ...
    light_curve_master = pd.read_csv(f'{master_input_folder_path_}/OMPLDG_croin_cassan.sample.csv')
...
def creating_files(*, sample_index,subrun,event_id,
    ...
    for i in range(1,4):
        ...
        if os.path.exists(f'{data_folder_}/Roman{filter_}sat{i}.dat'):
            ...
            lightcurve_data_df_list[i-1].to_csv(f'{data_folder_}/Roman{filter_}sat{i}.dat', sep=' ',
