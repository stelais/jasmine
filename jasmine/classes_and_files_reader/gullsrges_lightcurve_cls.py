...
import jasmine.classes_and_files_reader.gullsrges_reader as grr
import pandas as pd


class LightcurveEventGULLSRGES:
    def __init__(self, master_file_index, data_folder='../data'):
        self.sample_index = master_file_index
        #No data challenge LC number in this sample, so we should just indentify each event by it's order in the sample.csv file.
        self.data_folder = data_folder
        master_path = f'{data_folder}/OMPLLD_croin_cassan_0.sample.csv'
        master_df = pd.read_csv(master_path)
        self.lightcurve_master = master_df[master_df.index == self.sample_index]
        ...
        #They are all binary/planetary and we will run RTModel on the whole group
...
class SourceStarProperties:
    ...
    def __init__(self, lightcurve_master: pd.DataFrame):
        ...
        self.source_metalicity = lightcurve_master['Source_[Fe/H]'].values[0]
        self.source_alpha_Fe = lightcurve_master['Source_[alpha/Fe]'].values[0]
        ...
        self.source_ra = lightcurve_master['Source_RA2000.0'].values[0]
        self.source_dec = lightcurve_master['Source_DEC2000.0'].values[0]
...
class LensStarProperties:
    ...
    def __init__(self, lightcurve_master: pd.DataFrame):
        ...
        self.lens_ra = lightcurve_master['Lens_RA2000.0'].values[0]
        self.lens_dec = lightcurve_master['Lens_DEC2000.0'].values[0]
        ...
        self.lens_metalicity = lightcurve_master['Lens_[Fe/H]'].values[0]
        self.lens_alpha_Fe = lightcurve_master['Lens_[alpha/Fe]'].values[0]
...
class MicrolensingParameters:
    ...
    def __init__(self, lightcurve_master: pd.DataFrame):
        ...
        self.microlensing_relative_proper_motion_murel_alpha_helio___1masyr = lightcurve_master['murel_helio_alpha'].values[0] 
        self.microlensing_relative_proper_motion_murel_delta_helio___1masyr = lightcurve_master['murel_helio_delta'].values[0]
        ...
        self.microlensing_relative_proper_motion_murel_lambda_helio___1masyr = lightcurve_master['murel_helio_lambda'].values[0] 
        #Reference Frame Relative Proper Motion (Roman)                                 
        ...
        self.microlensing_relative_proper_motion_murel_ref__1masyr = lightcurve_master['murel_ref'].values[0]
        self.microlensing_relative_proper_motion_murel_alpha_ref___1masyr = lightcurve_master['murel_ref_alpha'].values[0] 
        self.microlensing_relative_proper_motion_murel_delta_ref___1masyr = lightcurve_master['murel_ref_delta'].values[0]
        ...
        self.microlensing_relative_proper_motion_murel_lambda_ref___1masyr = lightcurve_master['murel_ref_lambda'].values[0] 
        self.microlensing_relative_proper_motion_murel_beta_ref___1masyr = lightcurve_master['murel_ref_beta'].values[0]       
        #Transverse Velocity                        
