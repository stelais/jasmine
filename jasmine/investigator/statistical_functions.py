...
if __name__ == '__main__':
    ...
    parallax_24_summary_df =  pd.read_csv(f'/Users/stela/Documents/Scripts/orbital_task/RTModel_runs/'
                                          f'sample_rtmodel_v2.4/all_sample_rtmodel_v2.4_parallax.csv',
